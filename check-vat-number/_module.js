...
function add_css$1(target) {
	append_styles(target, "svelte-16pn5km", ".svelte-16pn5km.svelte-16pn5km{position:relative;z-index:1}.section-container.svelte-16pn5km.svelte-16pn5km{display:grid;gap:3.5rem;max-width:var(--inner-max-width);padding-block:5rem;position:relative}.headline.svelte-16pn5km.svelte-16pn5km{max-width:800px;margin:0 auto;font-size:clamp(2rem, 10vw, 5rem);line-height:1;letter-spacing:-0.04rem;font-weight:700;text-align:center;text-wrap:balance}form.svelte-16pn5km.svelte-16pn5km{display:flex;flex-wrap:wrap;gap:0.3rem;max-width:400px;justify-self:center}form.svelte-16pn5km label.svelte-16pn5km{flex:1}form.svelte-16pn5km label input.svelte-16pn5km{width:100%;padding:0.6rem 0.75rem;outline-color:transparent;transition:0.1s outline-color;border:1.5px solid var(--border-color, #eee);font-weight:300;border-radius:0.25rem}form.svelte-16pn5km label input.svelte-16pn5km:focus{outline-color:var(--color-accent, rebeccapurple)}.message.svelte-16pn5km.svelte-16pn5km{text-align:center;background:var(--background, white);padding:1rem;box-shadow:1px 1px 10px 5px rgba(0, 0, 0, 0.1);border-radius:0.25rem}.message.error.svelte-16pn5km.svelte-16pn5km{border:2px solid red}@media(prefers-reduced-motion){}@-webkit-keyframes svelte-16pn5km-left-float{to{rotate:5deg;transform:translateX(20px)}}@keyframes svelte-16pn5km-left-float{to{rotate:5deg;transform:translateX(20px)}}@-webkit-keyframes svelte-16pn5km-right-float{to{rotate:-20deg;transform:translateX(-20px)}}@keyframes svelte-16pn5km-right-float{to{rotate:-20deg;transform:translateX(-20px)}}");
}

// (210:18) 
function create_if_block_3(ctx) {
	let div;
	let t_1_value = /*form*/ ctx[1].error_message + "";
	let t_1;
	let div_intro;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*form*/ 2 && t_1_value !== (t_1_value = /*form*/ ctx[1].error_message + "")) set_data(t_1, t_1_value);
		},
		i(local) {
			if (!div_intro) {
				add_render_callback(() => {
...
function create_if_block_2$1(ctx) {
	let div;
	let t_1_value = /*form*/ ctx[1].success_message + "";
	let t_1;
	let div_intro;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*form*/ 2 && t_1_value !== (t_1_value = /*form*/ ctx[1].success_message + "")) set_data(t_1, t_1_value);
		},
		i(local) {
			if (!div_intro) {
				add_render_callback(() => {
...
function create_if_block_1$2(ctx) {
	let t_1_value = /*form*/ ctx[1].button_label + "";
	let t_1;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*form*/ 2 && t_1_value !== (t_1_value = /*form*/ ctx[1].button_label + "")) set_data(t_1, t_1_value);
		},
		i: noop,
		o: noop,
		d(detaching) {
...
function create_fragment$3(ctx) {
	...
	let if_block;
	let current;
	const if_block_creators = [create_if_block$2, create_if_block_2$1, create_if_block_3];
	const if_blocks = [];
...
function instance$3($$self, $$props, $$invalidate) {
	...
	async function submit_form(e) {
		...
		const { status } = await axios.get(form.endpoint, {
			params: { vatNumber: form_data.vatnumber }
		}).catch(e => ({ status: 400 }));
	...
	$$self.$$set = $$props => {
		...
		if ('de' in $$props) $$invalidate(9, de = $$props.de);
		if ('ti' in $$props) $$invalidate(10, ti = $$props.ti);
		if ('des' in $$props) $$invalidate(11, des = $$props.des);
		if ('tit' in $$props) $$invalidate(12, tit = $$props.tit);
		if ('desc' in $$props) $$invalidate(13, desc = $$props.desc);
		if ('titl' in $$props) $$invalidate(14, titl = $$props.titl);
		if ('descr' in $$props) $$invalidate(15, descr = $$props.descr);
		if ('title' in $$props) $$invalidate(16, title = $$props.title);
		if ('descri' in $$props) $$invalidate(17, descri = $$props.descri);
		if ('descrip' in $$props) $$invalidate(18, descrip = $$props.descrip);
		if ('descript' in $$props) $$invalidate(19, descript = $$props.descript);
		if ('descripti' in $$props) $$invalidate(20, descripti = $$props.descripti);
		if ('descriptio' in $$props) $$invalidate(21, descriptio = $$props.descriptio);
		if ('description' in $$props) $$invalidate(22, description = $$props.description);
...
function create_fragment$5(ctx) {
	...
	component_2 = new Component$3({
			props: {
				...
				descriptio: "Deserunt aliquip est",
				description: "We're passionate about building a better meeting workflow",
				heading: "Verify an EU VAT number",
				form: {
					"endpoint": "https://eu-vat-validation-ioaevjqkcq-od.a.run.app/vat/verify",
